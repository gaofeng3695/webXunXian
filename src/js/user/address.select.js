...
var addressObj = (function() {
    ...
    var setAdress = function(code) {
        ...
        if (code) {
            ...
            city.html('<option value="">请选择</option>').prop('disabled', true);;
            county.html('<option value="">请选择</option>').prop('disabled', true);;
            town.html('<option value="">请选择</option>').prop('disabled', true);;
            for (var i = 0; i < a.length; i++) {
                provinceText = '<option value="' + a[i].code + '">' + a[i].name + '</option>';
                province.append(provinceText);
            }

(function() {
    ...
    function swiper(pics, index, leng) {
        var me = this,
            touch;
        ...
        for (var i = 0; i < leng; i++) {
            var swiper_item = document.createElement("div");
            swiper_item.className = 'swiper-item';
            me.swiper_list_body.appendChild(swiper_item);
        };
        me.total_mun = me.node.getElementsByClassName('total-mun')[0];
        me.total_mun.innerHTML = leng;

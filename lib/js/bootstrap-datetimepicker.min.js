! function(c) {
    ...
    var e = function(h, g) {
        ...
        this.picker = c(b.template).appendTo(this.isInline ? this.element : "body").on({ click: c.proxy(this.click, this), mousedown: c.proxy(this.mousedown, this) });
        if (this.isInline) { this.picker.addClass("datetimepicker-inline") } else { if (this.component && this.pickerPosition == "bottom-left") { this.picker.addClass("datetimepicker-dropdown-left dropdown-menu") } else { this.picker.addClass("datetimepicker-dropdown dropdown-menu") } }
        if (this.isRTL) {
    ...
    e.prototype = {
        ...
        setValue: function() {
            ...
            if (!this.isInput) {
                if (this.component) { this.element.find("input").prop("value", g) }
        ...
        place: function() {
            if (this.isInline) { return }
            var i = parseInt(this.element.parents().filter(function() { return c(this).css("z-index") != "auto" }).first().css("z-index")) + 2000;
            var h, g;
            if (this.component) {
                h = this.component.offset();
                g = h.left;
                if (this.pickerPosition == "bottom-left") { g += this.component.outerWidth() - this.picker.outerWidth() }
            } else {
                h = this.element.offset();
                g = h.left
            }
            this.picker.css({ top: h.top + this.height, left: g, zIndex: i })
        },
        update: function() {
            var g, h = false;
            if (arguments && arguments.length && (typeof arguments[0] === "string" || arguments[0] instanceof Date)) {
                g = arguments[0];
                h = true
            } else { g = this.isInput ? this.element.prop("value") : this.element.data("date") || this.element.find("input").prop("value") || this.initialDate }
            if (!g) {
                g = new Date();
                h = false
            }
        ...
        fill: function() {
            ...
            var p;
            while (E.valueOf() < g) {
                if (E.getUTCDay() == this.weekStart) { m.push("<tr>") }
                p = "";
                if (E.getUTCFullYear() < o || (E.getUTCFullYear() == o && E.getUTCMonth() < C)) { p += " old" } else { if (E.getUTCFullYear() > o || (E.getUTCFullYear() == o && E.getUTCMonth() > C)) { p += " new" } }
                if (this.todayHighlight && E.getUTCFullYear() == A.getFullYear() && E.getUTCMonth() == A.getMonth() && E.getUTCDate() == A.getDate()) { p += " today" }
                if (E.valueOf() == l) { p += " active" }
                if ((E.valueOf() + 86400000) <= this.startDate || E.valueOf() > this.endDate || c.inArray(E.getUTCDay(), this.daysOfWeekDisabled) !== -1) { p += " disabled" }
                m.push('<td class="day' + p + '">' + E.getUTCDate() + "</td>");
                if (E.getUTCDay() == this.weekEnd) { m.push("</tr>") }
            ...
            for (var v = 0; v < 60; v += this.minuteStep) {
                var r = f(o, C, h, x, v, 0);
                p = "";
                if (r.valueOf() < this.startDate || r.valueOf() > this.endDate) { p += " disabled" } else { if (Math.floor(s / this.minuteStep) == Math.floor(v / this.minuteStep)) { p += " active" } }
                if (this.showMeridian && d[this.language].meridiem.length == 2) {
            ...
            if (F == o) { j.eq(this.date.getUTCMonth()).addClass("active") }
            if (o < t || o > k) { j.addClass("disabled") }
            if (o == t) { j.slice(0, y).addClass("disabled") }
            if (o == k) { j.slice(u + 1).addClass("disabled") }
            m = "";
        ...
        showMode: function(g) {
            if (g) { var h = Math.max(0, Math.min(b.modes.length - 1, this.viewMode + g)); if (h >= this.minView && h <= this.maxView) { this.viewMode = h } }
    ...
    var d = c.fn.datetimepicker.dates = { en: { days: ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六", "星期日"], daysShort: ["周日", "周一", "周二", "周三", "周四", "周五", "周六", "周日"], daysMin: ["日", "一", "二", "三", "四", "五", "六", "日"], months: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"], monthsShort: ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"], meridiem: ["上午", "下午"], suffix: ["st", "nd", "rd", "th"], today: "今天" } };
    var b = {
        ...
        headTemplate: '<thead><tr><th class="prev"><i class="glyphicon glyphicon-arrow-left"/></th><th colspan="5" class="switch"></th><th class="next"><i class="glyphicon glyphicon-arrow-right"/></th></tr></thead>',
